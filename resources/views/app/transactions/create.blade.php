...
@section('content')
    <div x-data="transactionForm()" x-init="init()">
        ...
        <div class="bg-white border-b border-gray-100 px-5 py-4 flex items-center gap-4">
            ...
            <h1 class="text-lg font-semibold text-gray-800">Add Transaction</h1>
        </div>
        ...
        <div class="px-5 pt-6 pb-4">
            <div class="grid grid-cols-3 gap-3 sm:gap-4">
                <button @click="pressKey('1')"
                    class="py-4 sm:py-5 bg-white hover:bg-white-100 rounded-xl text-xl sm:text-2xl font-semibold text-gray-700 transition-colors min-h-[52px]">1</button>
                <button @click="pressKey('2')"
                    class="py-4 sm:py-5 bg-white hover:bg-white-100 rounded-xl text-xl sm:text-2xl font-semibold text-gray-700 transition-colors min-h-[52px]">2</button>
                <button @click="pressKey('3')"
                    class="py-4 sm:py-5 bg-white hover:bg-white-100 rounded-xl text-xl sm:text-2xl font-semibold text-gray-700 transition-colors min-h-[52px]">3</button>
                <button @click="pressKey('4')"
                    class="py-4 sm:py-5 bg-white hover:bg-white-100 rounded-xl text-xl sm:text-2xl font-semibold text-gray-700 transition-colors min-h-[52px]">4</button>
                <button @click="pressKey('5')"
                    class="py-4 sm:py-5 bg-white hover:bg-white-100 rounded-xl text-xl sm:text-2xl font-semibold text-gray-700 transition-colors min-h-[52px]">5</button>
                <button @click="pressKey('6')"
                    class="py-4 sm:py-5 bg-white hover:bg-white-100 rounded-xl text-xl sm:text-2xl font-semibold text-gray-700 transition-colors min-h-[52px]">6</button>
                <button @click="pressKey('7')"
                    class="py-4 sm:py-5 bg-white hover:bg-white-100 rounded-xl text-xl sm:text-2xl font-semibold text-gray-700 transition-colors min-h-[52px]">7</button>
                <button @click="pressKey('8')"
                    class="py-4 sm:py-5 bg-white hover:bg-white-100 rounded-xl text-xl sm:text-2xl font-semibold text-gray-700 transition-colors min-h-[52px]">8</button>
                <button @click="pressKey('9')"
                    class="py-4 sm:py-5 bg-white hover:bg-white-100 rounded-xl text-xl sm:text-2xl font-semibold text-gray-700 transition-colors min-h-[52px]">9</button>
                <button @click="pressKey('0')"
                    class="py-4 sm:py-5 bg-white hover:bg-white-100 rounded-xl text-xl sm:text-2xl font-semibold text-gray-700 transition-colors min-h-[52px]">0</button>
                <button @click="pressKey('backspace')"
                    class="py-4 sm:py-5 bg-white hover:bg-white-100 rounded-xl text-gray-500 transition-colors min-h-[52px] flex items-center justify-center col-span-2">
            ...
            <div class="grid grid-cols-1 gap-3 sm:gap-4 mt-3">
                <button @click="submitForm()"
                    class="py-4 sm:py-5 rounded-xl text-sm font-semibold transition-colors min-h-[52px] 
               bg-emerald-100 hover:bg-emerald-50 text-emerald-600">
                    Save
                </button>
            </div>
        </div>
        ...
        {{-- Hidden Form --}}
        <form x-ref="transactionForm" method="POST" action="{{ route('transactions.store') }}" class="hidden">
            @csrf
    ...
    <script>
        function transactionForm() {
            return {
                ...
                init() {
                    const firstCategory = document.querySelector('[x-show="type === \'expense\'"]');
                    if (firstCategory) {
                        this.categoryId = parseInt(firstCategory.getAttribute('x-bind@click')?.match(/\d+/)?.[0]) || null;
                    }
                },
