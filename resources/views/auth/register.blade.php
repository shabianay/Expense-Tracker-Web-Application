...
<head>
    ...
    <title>Daftar - Expense Tracker</title>
    ...
    <div class="max-w-md w-full mx-auto">
        ...
        <div class="bg-white rounded-2xl p-6 shadow-sm border border-gray-100">
            <form method="POST" action="{{ route('register') }}" class="space-y-4">
                ...
                <div>
                    <label for="name" class="block text-xs font-semibold text-gray-600 mb-1">Nama Lengkap</label>
                ...
                <div>
                    <label for="password_confirmation" class="block text-xs font-semibold text-gray-600 mb-1">Konfirmasi Password</label>
